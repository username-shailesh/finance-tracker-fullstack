        ...
        <Link to="/dashboard" className="navbar-brand">
          <div className="navbar-brand-logo-container">
            <div className="shopping-bag-back-small">
              ...
              <span className="bag-currency-small" style={getSmallSymbolStyle(symbol, true)}>{symbol}</span>
            </div>
            <div className="shopping-bag-front-small">
              <span className="bag-currency-small" style={getSmallSymbolStyle(symbol, false)}>{symbol}</span>
